...
describe('Kindergarten', function() {
  ...
  describe('exposed errors', function() {
    ...
    it('exposes NoExposedMethodsError', function() {
      expect(this.Kindergarten.NoExposedMethodsError).toBe(NoExposedMethodsError);
      expect(this.Kindergarten.NoExposedMethodsError).toBeDefined();
    });
